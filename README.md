...
In this specific example, the word ਨਉ is translated from Bh. Manmohan Singh's translation as ਨਾਉ (Name), whereas our team would translate it as ਨੂੰ (to). This is based on the 3rd definition in Mahan Kosh as well as translations from Faridkot Teeka, Bh. Joginder Singh Talwara's (Daar ji's) Saral Steek, and GurmatBibek.
